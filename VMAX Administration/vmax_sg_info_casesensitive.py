...
#
# Modified the original script to make it case sensitive for SG names
# vmax_sg_info_casesensitive.py
# Changelog (DD/MM/YYYY):
# 02/02/2018 - first version
#
##############################################################################
#
# Prerequisite
...
#  <SG>
#   <SG_Info>
#     <name>SG_NOHOST_AMPRD_Arc</name>
#     <symid>000195702053</symid>
#     <update_time>Mon Apr 25 19:09:24 2016</update_time>
#     <emulation>FBA</emulation>
#     <Masking_views>No</Masking_views>
#     <FAST_Policy>No</FAST_Policy>
#     <FAST_Managed>No</FAST_Managed>
#     <SLO_name>N/A</SLO_name>
#     <Workload>N/A</Workload>
#     <SRP_name>N/A</SRP_name>
#     <Compression>N/A</Compression>
#     <vp_saved_percent>N/A</vp_saved_percent>
#     <compression_ratio>N/A</compression_ratio>
#     <Num_of_GKS>0</Num_of_GKS>
#     <HostIOLimit_status>None</HostIOLimit_status>
#     <HostIOLimit_max_mb_sec>N/A</HostIOLimit_max_mb_sec>
#     <HostIOLimit_max_io_sec>N/A</HostIOLimit_max_io_sec>
#     <Dynamic_Distribution>N/A</Dynamic_Distribution>
#     <SG_group_info>
#       <count>0</count>
#     </SG_group_info>
#   </SG_Info>
...
#   <DEVS_List>
#     <Device>
#       <dev_name>094DB</dev_name>
#       <pd_name>Not Visible</pd_name>
#       <configuration>RDF2+TDEV</configuration>
#       <gatekeeper>False</gatekeeper>
#       <status>WD</status>
#       <megabytes>117641</megabytes>
#     </Device>
#     <Device>
#       <dev_name>094E1</dev_name>
#       <pd_name>Not Visible</pd_name>
#       <configuration>RDF2+TDEV</configuration>
#       <gatekeeper>False</gatekeeper>
#       <status>WD</status>
...
#        sg_name = sg.title().upper() # get the SG (key) of the dict
        sg_name = sg # get the SG (key) of the dict
        # SG is standalone
